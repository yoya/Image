...
$IM_CONV "${OUTPUT_DIR}/${SAMPLE_RGBY}.png" -profile ${ICC_sRGB} "${OUTPUT_ICCPROF_DIR}/${SAMPLE_RGBY}-sRGB.jpg"
$IM_CONV "${OUTPUT_DIR}/${SAMPLE_RGBY}.png" -profile ${ICC_sRGB} "${OUTPUT_ICCPROF_DIR}/${SAMPLE_RGBY}-sRGB.png"
...
$IM_CONV $OUTPUT_DIR/$SAMPLE_RGBY.png -profile ${ICC_JC2011C} "${OUTPUT_ICCPROF_DIR}/${SAMPLE_RGBY}-cmyk.jpg"
